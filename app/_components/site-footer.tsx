...
import { repoUrl } from "@/app/_data/site";

export function SiteFooter() {
  return (
    <footer className="mt-11 flex flex-col gap-2.5 border-t border-ink-1 pt-4">
      <div className="flex flex-wrap items-baseline justify-between gap-x-6 gap-y-2 font-serif text-[15px] leading-none">
